const questions = [
  ...
  function showScore(){
    ...
    questionElement.innerHTML += `<br>You have ${remainingQuestions} questions left.`;
   
    const scorePercentage = (score / questions.length) * 100;
    let message = "";
    if (scorePercentage === 100) {
        message = "Perfect score! You're a HTML/CSS/JS master!";
    } else if (scorePercentage >= 80) {
        message = "Great job! You have a strong understanding of HTML/CSS/JS.";
    } else if (scorePercentage >= 50) {
        message = "Good effort! You have a decent understanding of HTML/CSS/JS.";
    } else {
        message = "Keep practicing! You'll get there with more study.";
    }
